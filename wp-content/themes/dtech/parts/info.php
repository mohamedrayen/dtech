			...
			<div class="col-lg-6 align-self-center">
				<div class="hosting-info-wraper">
					...
					<div class="wow fadeInUp">
						<h2 class="content-title">Obtenez les meilleurs plans pour plus de puissance</h2>
						<p>Notre solution WordPress de qualité supérieure, avec une optimisation supplémentaire pour faciliter la gestion d'une boutique en ligne WooCommerce. Nos prix sont clairs et directs afin que vous puissiez</p>
						<ul class="xs-list check">
							<li>Nous soutenons WordPress depuis le début.</li>
							<li>Parfait pour les grands sites ou les agences gérant plusieurs clients.</li>
							<li>Notre panneau de contrôle facile à utiliser et notre API vous permettent de passer du temps</li>
						</ul>
				...
				<div class="hosting-info-wraper-2 wow fadeInLeft" data-wow-duration="1.5s">
					...
					<div class="media hosting-info-list">
						...
						<div class="media-body">
							...
							<p>Notre solution WordPress de qualité supérieure, avec une optimisation supplémentaire pour faciliter la gestion d'une boutique en ligne WooCommerce</p>
						</div>
					...
					<div class="media hosting-info-list">
						...
						<div class="media-body">
							<h4 class="xs-title small">Transferts de site sans temps d'arrêt</h4>
							<p>Notre solution WordPress de qualité supérieure, avec une optimisation supplémentaire pour faciliter la gestion d'une boutique en ligne WooCommerce</p>
						</div>
					</div><!-- .hosting-info-list END -->
					<div class="media hosting-info-list">
